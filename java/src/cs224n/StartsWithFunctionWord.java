 ...
 * A rule featurizer.
 */
public class StartsWithFunctionWord implements RuleFeaturizer<IString, String> {
  ...
  public List<FeatureValue<String>> ruleFeaturize(
    ...
    if (f.targetPhrase != null && f.targetPhrase.size() > 0) {
      String firstWord = f.targetPhrase.get(0).toString();
      if (functionWords.contains(firstWord)) {
